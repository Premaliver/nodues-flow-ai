  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl gradient-surface shadow-glow font-display text-2xl font-bold">
          404
        </div>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-lg gradient-surface px-5 py-2.5 text-sm font-semibold shadow-glow transition hover:opacity-95"
          >
            Back to home
          </Link>
        </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-lg gradient-surface px-4 py-2 text-sm font-semibold shadow-glow transition hover:opacity-95"
          >
            Try again
          </button>
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-foreground transition hover:bg-accent/20"
          >
            Go home
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Smart NoDues AI — Digital No-Dues for Rayat Bahra University" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Smart NoDues AI — Digital No-Dues for Rayat Bahra University" },
      {
        ...
        content:
          "AI-powered No-Dues platform replacing hours of offline approvals with a real-time, verifiable digital workflow.",
      },
